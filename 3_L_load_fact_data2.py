...
# WICHTIG: station_code in dim_station auf int casten,
# damit der Merge mit df["start_station_id"] & df["end_station_id"] (ebenfalls int) gelingt
stationen["station_code"] = pd.to_numeric(stationen["station_code"], errors="coerce").astype(int)
